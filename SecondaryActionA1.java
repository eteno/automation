...
public class SecondaryActionA1 {
	...
	public static void main(String[] args) {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h2[@class='ux-title-name text-center']")));
		
		try {
		Assert.assertEquals("Dispute: Polly Plaintiff - Donnie Defendant", driver.findElement(By.xpath("//h2[@class='ux-title-name text-center']")).getText());
		...
		WebElement txtDefSignature = driver.findElement(By.xpath("//input[@name='fulton_consentMediatorSignature']"));
		txtDefSignature.sendKeys(Constant.DefSignature);
